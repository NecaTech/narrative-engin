# Protocole : Weak Verb Purge (Purge des Verbes Faibles)
...
- faire, aller, mettre, prendre, donner, voir

### Constructions à Éviter
- "se mit à [verbe]" → [verbe] directement
- "était en train de" → forme progressive simple
- "il y avait" → reformulation active
