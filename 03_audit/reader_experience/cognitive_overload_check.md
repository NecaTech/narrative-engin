# Protocole : Cognitive Overload Check (Vérification de Surcharge Cognitive)
...
### Alternatives pour Info-Dumps
- [ ] Peut-on fractionner l'info en plusieurs scènes ?
- [ ] Peut-on la montrer plutôt que la dire ?
- [ ] Peut-on la révéler via un flashback actif ou un dialogue naturel ?

## Seuils d'Alerte
- > 5 nouveaux noms/concepts par page
- Exposition > 200 mots sans dialogue, action ou interruption
- > 3 fils narratifs actifs simultanément
